...
class ListItem(models.Model):
	...
	project = models.CharField(null=True, max_length=200, blank=True)
	...
	def __str__(self):
		...
		return 'Item id:{}, name: {}, brand: {}, project: {}, unit_price: {}, total_price: {}, quantity: {}, specification: {}, quality: {}, vendor: {}, agent: {}, receipt_bool:{}, created_date: {}, updated_date: {}'.format(self.item_id, self.name, self.brand, self.project, self.unit_price, self.total_price, self.quantity, self.specification, self.quality, self.vendor, self.agent, self.receipt_bool, self.created_date, self.updated_date)
