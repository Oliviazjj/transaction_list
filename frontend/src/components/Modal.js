...
export default class AddTransactionModal extends Component {
  ...
  handleCheckChange = e => {
    ...
    console.log("in booleanchange name is "+name+", value is "+value+
      ", checked: "+checked);
  ...
  render() {
    ...
    return (
      <Modal isOpen={true} toggle={toggle}>
          ...
          <Form>
            ...
            <FormGroup>
              ...
              <Input
                type="checkbox"
                name="receipt_bool"
                checked={this.state.activeItem.receipt_bool}            
              ...
              <FormGroup>
              <Label for="updated_date">更新日期</Label>
              <Input
                type="date"
                name="updated_date"
                value={this.state.activeItem.updated_date}
                onChange={this.handleChange}
              />
              </FormGroup>
          </Form>
        ...
        <ModalFooter>
          <Button color="success" onClick={() => onSave(this.state.activeItem, this.props.type)}>
            Save
          </Button>
        </ModalFooter>
      </Modal>
